...
public class JualActivity extends AppCompatActivity implements NfcAdapter.CreateNdefMessageCallback,NfcAdapter.OnNdefPushCompleteCallback {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        editJudul= (EditText)findViewById(R.id.editTextJudul);
        editHarga= (EditText)findViewById(R.id.editTextHarga);
        editKeterangan= (EditText)findViewById(R.id.editTextKeterangan);
    }
