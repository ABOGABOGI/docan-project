...
import fw.docan.docan.cardemulation.CardEmulationFragment;

import static android.nfc.NdefRecord.createMime;


public class Kirim extends AppCompatActivity implements CreateNdefMessageCallback,OnNdefPushCompleteCallback {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        btnSetKirim = (Button)findViewById(R.id.btnSetKirim);

        EditText account = mEdit;
        account.setText(AccountStorage.GetAmount(this));
        account.addTextChangedListener(new Kirim.AccountUpdater());
